<!--
@Author: hopkinson
@Date:   2018-11-25T20:28:48+08:00
@Last modified by:   hopkinson
@Last modified time: 2018-11-25T20:40:10+08:00
-->
<template>
<scroller>
  隐私权政策
  ...
  【河源市盛商互联科技有限公司】（以下简称“我们”）深知个人信息对您的重要性，并会尽全力保护您的个人信息安全可靠。我们致力于维持您对我们的信任，恪守以下原则，保护您的个人信息：权责一致原则、目的明确原则、选择同意原则、最少够用原则、确保安全原则、主体参与原则、公开透明原则等。同时，我们承诺，我们将按业界成熟的安全标准，采取相应的安全保护措施来保护您的个人信息。
  ...
  （一）为您提供网上货运服务
  1、业务功能一：注册成为用户
  为完成创建账号，您需提供以下信息：您的姓名、手机号、身份证、创建的用户名和密码，如果您要注册的用户为司机账号，需额外提供行驶证、驾驶证、货运车照片。
  您提供的上述信息，将在您使用本服务期间持续授权我们使用。在您注销账号时，我们将停止使用并删除上述信息。
  上述信息将存储于中华人民共和国境内，不会跨境传输。
  ...
  我们不会将 Cookie 用于本政策所述目的之外的任何用途。您可根据自己的偏好管理或删除 Cookie。您可以清除计算机上保存的所有 Cookie，大部分网络浏览器都设有阻止 Cookie 的功能。但如果您这么做，则需要在每一次访问我们的网站时亲自更改用户设置。如需详细了解如何更改浏览器设置，请根据您所使用的浏览器帮助文档自行设置。
  （二）网站信标和像素标签
  ...
  账户信息——如果您希望访问或编辑您的账户中的个人资料信息和支付信息、更改您的密码、添加安全信息或关闭您的账户等，您可以通过访问编辑个人资料和修改密码执行此类操作。
  如果您无法通过上述链接访问这些个人信息，您可以随时使用我们的 Web 表单联系，或发送电子邮件至ssapp_dev@163.com。我们将在3天内回复您的访问请求。
  对于您在使用我们的产品或服务过程中产生的其他个人信息，只要我们不需要过多投入，我们会向您提供。如果您想行使数据访问权，请发送电子邮件至ssapp_dev@163.com。
  （二）更正您的个人信息
  当您发现我们处理的关于您的个人信息有错误时，您有权要求我们做出更正。您可以通过“（一）访问您的个人信息”中罗列的方式提出更正申请。
  如果您无法通过上述链接更正这些个人信息，您可以随时使用我们的 Web 表单联系，或发送电子邮件至ssapp_dev@163.com。我们将在3天内回复您的更正请求。
  （三）删除您的个人信息
  ...
  （四）改变您授权同意的范围
  每个业务功能需要一些基本的个人信息才能得以完成（见本策略“第一部分”）。对于额外收集的个人信息的收集和使用，您可以随时给予或收回您的授权同意，使用我们的 Web 表单联系，或发送电子邮件至ssapp_dev@163.com。我们将在3天内回复您的更正请求。
  （五）个人信息主体注销账户
  您随时可注销此前注册的账户，使用我们的 Web 表单联系，或发送电子邮件至ssapp_dev@163.com。我们将在3天内回复您的更正请求。
  （六）约束信息系统自动决策
  ...
  邮箱：ssapp_dev@163.com；电话：18933740000
  我们设立了个人信息保护专职部门（或个人信息保护专员），您可以通过以下方式与其联系：18933740000
  一般情况下，我们将在三天内回复。
