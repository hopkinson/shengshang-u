...
export default {
    ...
    props: {
        ...
        starImgs: {
            type: Array,
            default: [
                'https://weixin-res.flyme.cn/resources/weex-flymeui/assets/star1.png',
                'https://weixin-res.flyme.cn/resources/weex-flymeui/assets/star2.png',
                'https://weixin-res.flyme.cn/resources/weex-flymeui/assets/star3.png',
                'https://weixin-res.flyme.cn/resources/weex-flymeui/assets/star4.png',
                'https://weixin-res.flyme.cn/resources/weex-flymeui/assets/star5.png'
            ]
        },
        starSpecialImg: {
            type: String,
            default: 'https://weixin-res.flyme.cn/resources/weex-flymeui/assets/star_special.png'
        },
        starDarkImg: {
            type: String,
            default: 'https://weixin-res.flyme.cn/resources/weex-flymeui/assets/star_dark.png'
        },
        starBgImg: {
            type: String,
            default: 'https://weixin-res.flyme.cn/resources/weex-flymeui/assets/star_bg.png'
        },
        starDarkBgImg: {
            type: String,
            default: 'https://weixin-res.flyme.cn/resources/weex-flymeui/assets/star_dark_bg.png'
        }
    },
    data: () => ({
        offset_left: 0,
    ...
    methods: {
        ...
        calculateScore(pageX, needEmit) {
            ...
            needEmit && this.$emit('change', { score: this.score })
        }
    },
    mounted() {
